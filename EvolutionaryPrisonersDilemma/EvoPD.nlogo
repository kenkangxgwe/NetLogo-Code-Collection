...
to go
    ...
    ask links with [hidden? = false] [game]
    ask turtles with [score <= 0] [die]
    make-turtles
    tick
end
...
to make-links
    ...
    if (hidden-links-neighbor != nobody) [
        ...
        ask link ([who] of self) ([who] of hidden-links-neighbor) [show-link]
        ] [
...
to-report my-shown-links
    report count (my-links with [hidden? = false])
end
...
"" ""
PENS
"ALLC" 1.0 0 -10899396 true "" "plot count turtles with [strategy = \"ALLC\"]"
"TFT" 1.0 0 -1184463 true "" "plot count turtles with [strategy = \"TFT\"]"
"GTFT" 1.0 0 -13345367 true "" "plot count turtles with [strategy = \"GTFT\"]"
"WSLS" 1.0 0 -955883 true "" "plot count turtles with [strategy = \"WSLS\"]"
"ALLD" 1.0 0 -2674135 true "" "plot count turtles with [strategy = \"ALLD\"]"
